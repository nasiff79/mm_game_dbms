...
<nav class="w3-sidebar w3-bar-block w3-small w3-hide-small w3-center" style="width:10%">
  ...
  <a href="deleteList.php" class="w3-bar-item w3-button w3-padding-large w3-black">
...
<div class="w3-padding-24 " id="main">
  <!-- Header/Home -->
      <div class=" w3-content w3-justify w3-text-black w3-border  " id="about">
          ...
          <hr>
           <h1 class="w3-xxlarge w3-myfont w3-text-white w3-center">Game Deleted</h1>
    ...
    <!-- Grid for pricing tables -->
     <tr>
	  ...
	  <p align='center'><font size="2" face="Verdana, Arial, Helvetica, sans-serif"  color='white'><strong>Game Data has  been deleted. TQ.</strong></font></p>
	  <p>
        <?php
		//request nilai id
		$IDno = $_REQUEST['ID'];
		...
		$connect=mysqli_connect('localhost','root','','mydomain');
		 $SQLcommand = "DELETE FROM Games WHERE id=".$IDno;
