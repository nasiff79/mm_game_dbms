...
<div class="w3-padding-24 " id="main">
  <!-- Header/Home -->
      <div class=" w3-content w3-justify w3-text-black w3-border  " id="about">
          ...
          <hr>
           <h1 class="w3-xxlarge w3-myfont w3-text-white w3-center">Game Registered Successfully. </h1>
            
          <div class=" w3-text-black w3-padding">
	  <p align='center'><font size="2" face="Verdana, Arial, Helvetica, sans-serif"  color='white'><strong>Your details have been saved. TQ.</strong></font></p>
	  <p>
        <?php   
   	...
   	$connect=mysqli_connect('localhost','root','','mydomain');
			...
			$SQLcommand = "INSERT INTO games (name, developer, publisher, price, image, video) 
							VALUES ('$name', '$dev', '$pub', '$price', '$img', '$vid') ";
