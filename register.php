...
<div class="w3-padding-24" id="main">
  <!-- Header/Home -->
       <div class=" w3-content w3-justify w3-text-black w3-border  " id="about">
          ...
          <hr>
           <h1 class="w3-xxlarge w3-myfont w3-text-white w3-center">Register Games </h1>
   ...
   <tr>
	...
	<!-- <h1 align='center'><font face="Geneva, Arial, Helvetica, sans-serif" color='white' >Registration Form </font></h1>-->
      <p align='center'><font face="Geneva, Arial, Helvetica, sans-serif" color='white' >Please enter your details and click the submit button. </font></p>
        ...
        <div align="left"><span style = "color: blue"> </span>
          <table class='w3-border' align="center" border="1" cellspacing="2" cellpadding="3">
				...
				<td><input name="name" type="text" id="name" size="40" maxlength="50"></td></tr>
				<tr>
					<td><font size="2" face="Geneva, Arial, Helvetica, sans-serif" color='white'>Developer:</font></td>
			    <td><input name="developer" type="text" id="developer" size="40" maxlength="50"></td></tr>
				<tr>
					<td><font size="2" face="Geneva, Arial, Helvetica, sans-serif" color='white'>Publisher:</font></td>
			    <td><input name="publisher" type="text" id="publisher" size="40" maxlength="50"></td></tr>
              
              <td><font size="2" face="Geneva, Arial, Helvetica, sans-serif" color='white'>Price:</font></td>
			    <td><input name="price" type="text" id="price" size="40" maxlength="50"></td>
				<tr>
			
                    <td><font size="2" face="Geneva, Arial, Helvetica, sans-serif" color='white'> Insert Image:</font></td>
                    <td><font color='white'><Input type="file" name ="image" value ="select"></font></td>
              </tr>
                <tr>        
                    <td><font size="2" face="Geneva, Arial, Helvetica, sans-serif" color='white'> Insert Video:</font></td> 
                    <td><font color='white'><Input type="file" name ="video" value ="select"></font></td>
            </tr>
